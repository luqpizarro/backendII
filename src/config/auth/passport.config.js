...
import { Strategy as JwtStrategy} from 'passport-jwt' // instancia de strategy, de passport, lo nombras como jwtstrategy
import dotenv from 'dotenv';
import bcrypt from "bcrypt";
import { User } from "../../models/users.model.js";

//Para la JWT Strategy hay que crear una funcion para que lea el token desde la cookie
...
export function initPassport() {
    ...
    passport.use('jwt-cookie', new JwtStrategy(
        {
            jwtFromRequest: cookieExtractor, //Obtiene el token
            secretOrKey: process.env.JWT_SECRET //desencripta el token
        },
        async (payload, done) => {
            try {
